...
| `FS-1241` | Backend для рекуррентного оффера: ручка отдаёт по каждому экрану полную инфу (клиент, инвойсы, сумма, название айтема) + список кому показываем экраны; выборка пользователей с сильным фитом по рекуррентам. | [README](FS-1241/README.md) |
