...
| `meta_us` (Meta Marketing API mirror: campaigns/adsets/ads/insights, `act_2725877157763325`) | BigQuery | prod=`inv-project` | `Tofu.AI.Backend` (meta-ingest tick) | `Analyses:Meta` + `BigQuery:MetaDatasetId` | [query guide](bigquery-agent-guide.md) |
